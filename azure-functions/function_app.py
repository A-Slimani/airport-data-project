...
def adl_airport_scraper(timer: func.HttpRequest) -> func.HttpResponse:
    try:
...
def bri_airport_scraper(timer: func.HttpRequest) -> func.HttpResponse:
...
def mel_airport_scraper(timer: func.HttpRequest) -> func.HttpResponse:
...
def per_airport_scraper(timer: func.HttpRequest) -> func.HttpResponse:
